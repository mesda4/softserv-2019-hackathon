    ...
    <div v-if="pet" class="pet block">
        ...
        <div class="main-img">
            ...
            <div>
                <button
                    @click="addPet(pet.id)"
                    class="add-pet-btn round-btn waves-effect waves-light btn"
                >
        ...
        <div class="inner-wrap">
            ...
            <div class="toggle-gallery-btn">
                <button
                    @click="isGalleryShowed = !isGalleryShowed"
            ...
            <div class="gallery" v-if="isGalleryShowed">
                <div><img src="../1/1.2.jpg" alt=""></div>
                <div><img src="../1/1.3.jpg" alt=""></div>
                <div><img src="../1/1.4.jpg" alt=""></div>
                <div><img src="../1/1.5.jpg" alt=""></div>
            </div>
